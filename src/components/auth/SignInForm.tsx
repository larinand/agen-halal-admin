...
export default function SignInForm() {
  ...
  const onSubmit = (ev: { preventDefault: () => void; }) => {
    ...
    console.log(payload)
    axiosClient.post('/tokens/create', payload)
      .then(({ data }) => {
    ...
    <div className="min-h-screen flex items-center justify-center bg-white">
      <div className="w-full max-w-md p-8 space-y-6 rounded-md">
        <h2 className="text-2xl font-bold text-center">
          Welcome, Agent<br />
          <span className="text-black">Please <u className="text-blue-500">Sign in</u> to continue.</span>
        </h2>
        ...
        <button className="w-full bg-black text-white py-2 rounded">Test Alert</button>
